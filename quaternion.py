...
def rotate_quat(q1,v1):
    ans = quat_mult(quat_mult(q1, np.append([[0]], v1, axis=0)),
                    np.array([q1[0,:],-q1[1,:], -q1[2,:], -q1[3,:]]))
    return np.array([ans[1,:], ans[2,:], ans[3,:]]) # to covert to 3x1 vec

def ca_rotate_quat(q1,v1):
